...
<script defer src="{{ asset('themes/frontend/js/beacon.min.js') }}"  hrv-beacon-t="1000252872"></script>
<script src="{{ asset('themes/frontend/js/sdk.js') }}"></script>
<script src="{{ asset('themes/frontend/js/jquery.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('themes/frontend/js/modernizr.min4c33.js') }}" type="text/javascript"></script>
