                    ...
                    <div class="container">
                        <div class="clearfix">
                            <ul class="breadcrumb" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                                ...
                                <li class="item"><span itemprop="title"><a itemprop="url" href="{{ $url_taxonomy }}"
                                            title="{{ $title_taxonomy }}">{{ $title_taxonomy }}</a></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                                        ...
                                                        <div class="col-sm-6 product-center clearfix">
															...
															<div class="meta-status">
                                                                <div class="availability">
																	MSP: <span
																			class="available">{{ $detail->masanpham }}</span>
																</div>
                                                            </div>
                                                            <div class="meta-status">
                                                                <div class="availability">
                                                                    Tình trạng: <span
                                                                        class="available">{{ $detail->tinhtrang == 1 ? 'Còn hàng' : 'Hết hàng' }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="meta-desc">
                                                                {{ $brief }}
                                                            ...
                                                            <div class="price">
                                                                ...
                                                                <span class="price-new"><span
                                                                        id="price-old">&nbsp;{{ $detail->giakm != '' ? number_format($detail->giakm).' đ' : number_format($detail->gia).' đ' ?? 'Liên hệ' }}</span>
																</span>
                                                ...
                                                <div id="frm_rating">
                                                    <div>
                                                        ...
                                                        <div class="fb-comments"
                                                            data-href="{{ $url_link = route('frontend.cms.product', ['alias_detail' => $detail->alias]) . '.html' }}"
