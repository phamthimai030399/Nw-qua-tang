                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-9 col-ipad-12 col-sm-5 col-md-5 no-margin" id="header-center">
                                ...
                                <div class="search_form">
                                    <div class="search_box">
                                        <form action="{{ route('frontend.cms.product_search') }}" id='form-filter'
                                            method="post">
                                            @csrf
                            ...
                            <div class="col-xs-12 col-ipad-12 col-sm-4 col-md-4 display-pc">
                                <div class="" id="header-right">
                                    ...
                                    <a href="{{ route('frontend.order.tracking') }}" class="pointer">
                                    ...
                                    @else
                                        <div class="">
                                            <i class="fa-solid fa-circle-user"></i>
                                            <a href="{{ route('frontend.login') }}" class="pointer" style="border-right: 1px solid #ccc">Đăng nhập</a>
                                            <a href="{{ route('frontend.register') }}" class="pointer">Đăng ký</a>
                                        </div>
                                    @endif

                                    <a href="{{ route('frontend.order.cart') }}" class="pointer">
                                        ...
                                        <ul class="megamenu shift-down">
                                            ...
                                            <li class='mnu_about with-sub-menu hover'>
                                                ...
                                                <a href='/{{ $taxonomy->taxonomy }}/{{ $taxonomy->url_part }}.html'
                                                    title='{{ $taxonomy->title }}' class='clearfix'>
                                                    <span><strong>{{ $taxonomy->title }}</strong></span>
                                                </a>
                                                    ...
                                                    <div class='content'>
                                                        ...
                                                        <div class='row'>
                                                            <div class='col-sm-12  mobile-enabled'><a
                                                                    href='/{{ $sub_taxonomy->taxonomy }}/{{ $sub_taxonomy->url_part }}.html'
                                                                    title='{{ $sub_taxonomy->title }}'>{{ $sub_taxonomy->title }}</a>
                                                            </div>
                                                        </div>
