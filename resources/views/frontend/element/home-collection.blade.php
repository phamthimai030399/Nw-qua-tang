                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            ...
                                            <img class="product-img-hover" src="./assets/image/product-2.png"
                                                alt="Culotte dress" title="Culotte dress" />
                                            <div class="product-wishlist active" data-bs-toggle="offcanvas"
...
{{-- <style>
    ...
    .home-collection .home-collection_title h3 {
    ...
    .home-collection .home-collection_title {
        height: 50px;
        display: inline-block;
        width: 200px;
        position: relative;
    ...
    .home-collection .view-more a:hover {
        color: #0087cb;
    }
    .home-collection .view-more a i {
        margin-left: 3px;
    }
</style> --}}
