								...
								<div class="row">
									...
									<div class="block  ">
										...
										<div class="product product_wg clearfix product-hover">
											<div class="left">
												<div class="image ">
													<a class="sss" href="{{ $url_link }}" title="{{ $sanpham->title }}">
														<img src="{{ $sanpham->image }}" title="{{ $sanpham->title }}" alt="{{ $sanpham->title }}" class="">
													</a>
												</div>
											</div>
											<div class="right">
												<div class="name" style="">
													...
													<a href="{{ $url_link }}" title="{{ $sanpham->title }}">{{ $sanpham->title }}</a>
												</div>
												<div class="price">
												{{ $sanpham->giakm !='' ?  number_format($sanpham->giakm).' đ' :  number_format($sanpham->gia).' đ' ?? 'Liên hệ' }}
												</div>
