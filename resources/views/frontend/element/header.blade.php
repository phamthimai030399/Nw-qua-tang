             ...
             <div class="header-main">
                 ...
                 <div class="header-wrapper">
                     <div class="header-right">
                         ...
                         <div id="box-before-login" class="header-account header-icon" data-bs-toggle="modal"
                         ...
                         <div id="box-after-login" class="header-account header-icon d-none">
                             ...
                             <div class="acount-info-home d-none">
                                 <a href="{{ route('frontend.user.index') }}"
                                     class="user-name">{{ Auth::guard('web')->user()->name ?? '' }}</a>
                                 <div class="btn-logout">
                                     <a href="{{ route('frontend.logout') }}"><i class="fas fa-sign-out-alt"></i>Đăng
                                         xuất</a>
                                 </div>
                             </div>
                         </div>
                         <a href="{{ route('frontend.user.shop_cart') }}" title="cart"
 ...
 <script>
     $(document).ready(function() {
         ...
         @else
             $('#box-before-login').removeClass('d-none');
             $('#box-after-login').addClass('d-none');
         @endif
     });
 </script>
 <!-- END HEADER-->
