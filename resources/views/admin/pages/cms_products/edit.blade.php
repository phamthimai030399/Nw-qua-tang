                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" maxlength="255" id="txtTitle"
                                                ...
                                                name="title" placeholder="@lang('Title')" value="{{ $detail->title }}"
                                                required>
                                            <span id='remainingInput_text'
                                                class="note pull-right">{{ mb_strlen($detail->title) }}/255</span>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea name="mota" id="mota" maxlength="255" onkeyup="demKytu('description','remainingInput_textarea');"
                                                ...
                                                onclick="demKytu('description','remainingInput_textarea');" class="form-control" rows="5">{{ $detail->mota }}</textarea>
                                            <span id='remainingInput_textarea'
                                                class="note pull-right">{{ mb_strlen($detail->mota) }}/255</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="image" class="form-control" type="text" name="image"
                                                    value="{{ $detail->image }}" placeholder="@lang('image_link')...">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group hidden">
                                            ...
                                            <input type="text" class="form-control" id="txtUrlPart"
                                                ...
                                                placeholder="@lang('Alias')" value="{{ $detail->alias }}" required>
                                        </div>
										<div class="form-group">
                                            <label>@lang('Mã sản phẩm') <small class="text-red">*</small></label>
                                            <input type="text" class="form-control" name="masanpham"
                                                placeholder="@lang('Mã sản phẩm')" value="{{ $detail->masanpham }}" required>
                                        </div>
                                          ...
                                          <div class="row">
                                              <div class="col-xs-6">
                                                  ...
                                                  <input type="text" class="form-control" name="quantity"
                                                      placeholder="Số lượng" value="{{ $detail->quantity }}">
                                              </div>
                                              <div class="col-xs-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="meta_title" maxlength="255" id="meta_title"
                                                class="form-control" value="{{ $detail->meta_title }}"
                                            ...
                                            <span id='remainingInput_meta_title'
                                                class="note pull-right">{{ mb_strlen($detail->meta_title) }}/255</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="meta_keyword" maxlength="255" class="form-control"
                                                id="meta_keyword" value="{{ $detail->meta_keyword }}"
                                            ...
                                            <span id='remainingInput_meta_keyword'
                                                class="note pull-right">{{ mb_strlen($detail->meta_keyword) }}/255</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input name="meta_description" maxlength="255" id="meta_description"
                                                class="form-control" value="{{ $detail->meta_description }}"
                                            ...
                                            <span id='remainingInput_meta_description'
                                                class="note pull-right">{{ mb_strlen($detail->meta_description) }}/255</span>
                                        </div>
                                    </div>
