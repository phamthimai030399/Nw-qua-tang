...
<section class="related bg-smoke">
    <div class="container">
        <div class="related-title">
            <h3>Có thể bạn quan tâm</h3>
            <div class="line"></div>
        </div>
        <div class="swiper main-slider related-container">
            <div class="container">
                <div class="related-slider main-slider-container">
                            ...
                            <div class="swiper-slide related-item">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <a href="<?php echo e(route('frontend.cms.product', ['alias_detail' => $product->alias])); ?>"
                                            class="product-name" title="<?php echo e($product->title); ?>">
            ...
            <div class="swiper-button-prev main-slider-prev related-prev">
            ...
            <div class="swiper-button-next main-slider-next related-next">
                <svg width="11" height="16" viewBox="0 0 11 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
...
<!-- END PRODUCT DETAIL RELATED -->
<?php /**PATH F:\NEWWAY\Nw_Quatang\resources\views/frontend/element/product_related.blade.php ENDPATH**/ ?>