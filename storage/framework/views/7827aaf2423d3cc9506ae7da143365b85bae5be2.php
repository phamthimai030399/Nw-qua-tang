                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" maxlength="255" id="txtTitle"
                                                ...
                                                name="title" placeholder="<?php echo app('translator')->get('Title'); ?>" value="<?php echo e(old('title')); ?>"
                                                required>
                                            <span id='remainingInput_text'
                                                class="note pull-right"><?php echo e(mb_strlen(old('title'))); ?>/255</span>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea name="mota" id="mota" maxlength="255" onkeyup="demKytu('description','remainingInput_textarea');"
                                                ...
                                                onclick="demKytu('description','remainingInput_textarea');" class="form-control" rows="5"><?php echo e(old('mota')); ?></textarea>
                                            <span id='remainingInput_textarea'
                                                class="note pull-right"><?php echo e(mb_strlen(old('mota'))); ?>/255</span>
                                        </div>
                                        ...
                                        <div class="form-group">
										 ...
										 <div class="form-group hidden">
                                            ...
                                            <input type="text" class="form-control" id="txtUrlPart"
                                                ...
                                                placeholder="<?php echo app('translator')->get('Alias'); ?>" value="<?php echo e(old('alias')); ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Mã sản phẩm <small class="text-red">*</small></label>
                                            <input type="text" class="form-control" name="masanpham"
                                                placeholder="<?php echo app('translator')->get('Mã sản phẩm'); ?>" value="<?php echo e(old('masanpham')); ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-xs-6">
                                          ...
                                          <div class="row">
                                              <div class="col-xs-6">
                                                  ...
                                                  <input type="number" class="form-control" name="quantity"
                                                      placeholder="Giá" value="<?php echo e(old('quantity')); ?>">
                                              </div>
                                              <div class="col-xs-6">
                                                <label>Thứ tự</label>
                                            ...
                                            <div id="image_thumb-holder" style="margin-top:15px;max-height:100px;">
                                                <?php if(old('image_thumb') != ''): ?>
                                                    <img id="view_image_thumb" style="height: 5rem;"
                                                        src="<?php echo e(old('image_thumb')); ?>">
                                                <?php else: ?>
                                                    <img id="view_image_thumb" style="height: 5rem;">
                                                <?php endif; ?>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span id='remainingInput_meta_title'
                                                class="note pull-right"><?php echo e(mb_strlen(old('seo_title'))); ?>/255</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span id='remainingInput_meta_keyword'
                                                class="note pull-right"><?php echo e(mb_strlen(old('meta_keyword'))); ?>/255</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <span id='remainingInput_meta_description'
                                                class="note pull-right"><?php echo e(mb_strlen(old('meta_description'))); ?>/255</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <hr style="border-top: dashed 2px #a94442; margin: 10px 0px;">
                                            ...
                                            <ul class="checkbox_list">
                                                ...
                                                <li>
                                                  ...
                                                  <p class="mb-0 check_action">
                                                    ...
                                                    <label for="json_action_index_51"><strong><?php echo e($sdetai->title); ?></strong></label>
                                                    <?php } } ?>
                                                  </p>
                                                </li>
                                                <?php } ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp74\htdocs\emogift\resources\views/admin/pages/cms_products/create.blade.php ENDPATH**/ ?>