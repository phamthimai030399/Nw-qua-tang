    ...
    <div class="modal-dialog">
        <div class="modal-content login-modal">
            ...
            <div class="login-container">
                ...
                <form class="login-form main-form" accept-charset='UTF-8' action="<?php echo e(route('frontend.login.ajax')); ?>"
                    method='post'>
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="notification">
                        ...
                        <p><i style="color:#f07d00" class="success">
                                ...
                                <?php elseif(Session::has('registerSuccessMessage')): ?>
                                    <?php echo e(Session::get('registerSuccessMessage')); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content login-modal">
            ...
            <div class="login-container">
                ...
                <form class="login-form main-form" accept-charset='UTF-8' action="<?php echo e(route('frontend.register')); ?>"
                    method='post'>
                    <?php echo csrf_field(); ?>
                    <div class="main-form-wrapper">
                    ...
                    <div class="notification">
                        <?php if(Session::has('errorMessageEmail')): ?>
                            <p><i style="color: brown"><?php echo e(Session::get('errorMessageEmail')); ?></i></p>
                        <?php endif; ?>
                    </div>
                    <button type="submit" class="main-btn main-btn-full login-form-submit">
                        Đăng ký
...
<!-- END REGISTER POPUP-->
<script>
    <?php if(Session::has('loginErrorMessage') || Session::has('errorMessageEmail') || Session::has('registerSuccessMessage')): ?>
        $("#fhm-login-popup").modal('show');
    <?php endif; ?>
    <?php if(Session::has('registerErrorMessage')): ?>
...
<?php /**PATH F:\NEWWAY\Nw_Quatang\resources\views/frontend/element/popup_login.blade.php ENDPATH**/ ?>