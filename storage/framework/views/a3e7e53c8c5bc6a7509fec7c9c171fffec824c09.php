                                ...
                                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                                    <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                                        ...
                                        <tr class="valign-middle">
                                            <td>
                                                <img src="<?php echo e($row->image); ?>" style="height: 5rem;">
                                            </td>
                                            <td>
                                                <input type="text" id="tensanpham_<?php echo e($row->id); ?>"
                                            ...
                                            <td>
                                                <input type="number" id="giasanpham_<?php echo e($row->id); ?>"
                                            ...
                                            <td>
                                                <?php echo e($row->tinhtrang == 1 ? 'Còn hàng' : 'Hết hàng'); ?>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-primary" data-toggle="tooltip"
                                                    title="<?php echo app('translator')->get('save'); ?>" data-original-title="<?php echo app('translator')->get('save'); ?>"
                                                    onclick="saveService(<?php echo e($row->id); ?>)" href="javascript:;">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u745771642/domains/bibomart.thanhphung.com/public_html/resources/views/admin/pages/cms_products/index.blade.php ENDPATH**/ ?>