                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input name="meta_title" maxlength="255" id="meta_title" class="form-control" value="<?php echo e($detail->meta_title); ?>"
					  onchange="demKytu('meta_title','remainingInput_meta_title')" onclick="demKytu('meta_title','remainingInput_meta_title')" onblur="demKytu('meta_title','remainingInput_meta_title')">
						<span id='remainingInput_meta_title' class="note pull-right"><?php echo e(mb_strlen($detail->meta_title)); ?>/255</span>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label><?php echo app('translator')->get('seo_keyword'); ?></label>
                      <input name="meta_keyword" maxlength="255" class="form-control" id="meta_keyword" value="<?php echo e($detail->meta_keyword); ?>"
					  onchange="demKytu('meta_keyword','remainingInput_meta_keyword')" onclick="demKytu('meta_keyword','remainingInput_meta_keyword')" onblur="demKytu('meta_keyword','remainingInput_meta_keyword')">
						<span id='remainingInput_meta_keyword' class="note pull-right"><?php echo e(mb_strlen($detail->meta_keyword)); ?>/255</span>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label><?php echo app('translator')->get('seo_description'); ?></label>
                      <input name="meta_description" maxlength="255" id="meta_description" class="form-control" value="<?php echo e($detail->meta_description); ?>"
					  onchange="demKytu('meta_description','remainingInput_meta_description')" onclick="demKytu('meta_description','remainingInput_meta_description')" onblur="demKytu('meta_description','remainingInput_meta_description')">
						<span id='remainingInput_meta_description' class="note pull-right"><?php echo e(mb_strlen($detail->meta_description)); ?>/255</span>
                    </div>
                  </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tipcosexyw0p/domains/tipcosmetics.com.vn/public_html/resources/views/admin/pages/cms_products/edit.blade.php ENDPATH**/ ?>