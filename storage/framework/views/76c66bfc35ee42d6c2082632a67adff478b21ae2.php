...
<?php $__env->startSection('content'); ?>
  ...
  <section class="content">
    ...
    <div class="box box-primary">
      ...
      <!-- /.box-header -->
      <!-- form start -->
      <form role="form" action="<?php echo e(route('web.update', $detail->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <span class="input-group-btn">
                    <a data-input="<?php echo e($key); ?>" onclick="openPopupImg('<?php echo e($key); ?>')" data-preview="<?php echo e($key); ?>-holder" data-type="logo"
                ...
                <div id="<?php echo e($key); ?>-holder" style="margin-top:15px;max-height:100px;">
                  <?php if(isset($value) && $value != ''): ?>
                    <img id="view_<?php echo e($key); ?>" style="height: 5rem;" src="<?php echo e($value ?? old('option_value[$key]')); ?>">
                  <?php endif; ?>
                </div>
              </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u745771642/domains/bibomart.thanhphung.com/public_html/resources/views/admin/pages/options/web_image.blade.php ENDPATH**/ ?>