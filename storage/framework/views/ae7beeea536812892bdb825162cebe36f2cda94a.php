...
<div id="NavDrawer" class="drawer drawer--left">
    <div class="drawer__header">
        <div class="drawer__title h3">
            <?php echo e($web_infomation->information->site_name ?? ""); ?>
                ...
                <div class="grid">
                    <div class="grid__item large--six-twelfths mediumm--six-twelfths small--six-twelfths">
                        <div class="header-top-contact text-left">
                            <a href="tel:<?php echo e($web_information->information->hotline); ?>"><i class="fa fa-phone-square" aria-hidden="true"></i>
                                Hotline: <?php echo e($web_information->information->hotline); ?></a>
                            <a href="mailto:<?php echo e($web_information->information->email ?? ""); ?>"><i class="fa fa-envelope"
                                    aria-hidden="true"></i>
                                <?php echo e($web_information->information->email ?? ""); ?></a>
                        </div>
                    </div>
                    <div class="grid__item large--six-twelfths mediumm--six-twelfths small--six-twelfths">
...
<?php /**PATH F:\NEWWAY\emogift\resources\views/frontend/element/header.blade.php ENDPATH**/ ?>