						...
						<div class="row">
							<div class="col-xs-6">
							  ...
							  <div class="input-group">
								<span class="input-group-btn">
								  <a data-input="image_background" data-preview="image_background-holder" onclick="openPopupImg('image_background')"
							...
							<div class="col-xs-6">
								<label><?php echo app('translator')->get('Image'); ?></label>
								  <div class="input-group">
									<span class="input-group-btn">
									  <a data-input="image" data-preview="image-holder" class="btn btn-primary lfm" onclick="openPopupImg('image')"
										data-type="category">
										<i class="fa fa-picture-o"></i> <?php echo app('translator')->get('choose'); ?>
									  </a>
									</span>
                  ...
                  <div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="form-control">
							...
							<input type="checkbox" class="ml-15" id="hienthi_3" name="hienthi[]" value="3" <?php if(in_array('3',$hienthi)) echo 'checked'; ?>>
							<label for="vehicle1"> Danh mục nổi bật trang chủ</label>
						</div>
                    </div>
                  </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u745771642/domains/bibomart.thanhphung.com/public_html/resources/views/admin/pages/cms_taxonomys/edit.blade.php ENDPATH**/ ?>