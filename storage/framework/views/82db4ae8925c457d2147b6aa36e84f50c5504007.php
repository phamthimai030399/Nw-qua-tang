...
<body>
    ...
    <?php echo $__env->make('frontend.element.popup_login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php echo $__env->make('frontend.panels.scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</body>
<?php /**PATH F:\NEWWAY\Nw_Quatang\resources\views/frontend/layouts/default.blade.php ENDPATH**/ ?>