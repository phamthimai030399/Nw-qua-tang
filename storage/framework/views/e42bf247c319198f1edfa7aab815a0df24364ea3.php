        ...
        <section class="breadcrumb">
            <div class="container">
                <div class="breadcrumb-list">
                    ...
                    <a href="<?php echo e(route('frontend.contact')); ?>" title="Liên hệ"
            ...
            <div class="container">
                <div class="contact-container row justify-content-between">
                    <div class="col-12 col-lg-6 box-content-right d-flex">
                        <div>
                            <h4><?php echo e($web_information->information->site_name); ?></h4>
                            <p><span>Địa chỉ: </span><?php echo e($web_information->information->address); ?></p>
                            <p><span>Email: </span><?php echo e($web_information->information->email); ?></p>
                            <p><span>Hotline: </span><?php echo e($web_information->information->hotline); ?></p>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\NEWWAY\Nw_Quatang\resources\views/frontend/pages/contact/index.blade.php ENDPATH**/ ?>