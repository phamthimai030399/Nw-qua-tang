        ...
        <div class="box-body">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="local" placeholder="Tên nhãn là duy nhất"
                value="<?php echo e(old('local')); ?>" required>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="translations" placeholder="" required
                  value="<?php echo e(old('translations')); ?>">
            </div>
          </div>
        </div>
        <!-- /.box-body -->
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u745771642/domains/bibomart.thanhphung.com/public_html/resources/views/admin/pages/cms_translate/create.blade.php ENDPATH**/ ?>