            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea class="form-control" name="option_value[<?php echo e($key); ?>]" id="option_value_<?php echo e($key); ?>"
                  rows="8" placeholder="<?php echo e(__($key)); ?>"><?php echo e($value); ?></textarea>
              </div>
            </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u745771642/domains/bibomart.thanhphung.com/public_html/resources/views/admin/pages/options/web_source.blade.php ENDPATH**/ ?>