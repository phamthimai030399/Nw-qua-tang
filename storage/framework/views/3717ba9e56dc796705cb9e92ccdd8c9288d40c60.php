                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" maxlength="255" id="txtTitle"
                                                ...
                                                name="title" placeholder="<?php echo app('translator')->get('Title'); ?>" value="<?php echo e($detail->title); ?>"
                                                required>
                                            <span id='remainingInput_text'
                                                class="note pull-right"><?php echo e(mb_strlen($detail->title)); ?>/255</span>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea name="mota" id="mota" maxlength="255" onkeyup="demKytu('description','remainingInput_textarea');"
                                                ...
                                                onclick="demKytu('description','remainingInput_textarea');" class="form-control" rows="5"><?php echo e($detail->mota); ?></textarea>
                                            <span id='remainingInput_textarea'
                                                class="note pull-right"><?php echo e(mb_strlen($detail->mota)); ?>/255</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="image" class="form-control" type="text" name="image"
                                                    value="<?php echo e($detail->image); ?>" placeholder="<?php echo app('translator')->get('image_link'); ?>...">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control">
                                                <input type="checkbox" id="hienthi_0" name="hienthi[]"
                                                    <?php if (in_array('0', $hienthi)) {
                                                        echo 'checked';
                                                    } ?> value="0">
                                                <label for="vehicle1"> SP bán chạy</label>
                                        ...
                                        <div class="form-group hidden">
                                            ...
                                            <input type="text" class="form-control" id="txtUrlPart"
                                                ...
                                                placeholder="<?php echo app('translator')->get('Alias'); ?>" value="<?php echo e($detail->alias); ?>" required>
                                        </div>
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="masanpham"
                                                placeholder="<?php echo app('translator')->get('Mã sản phẩm'); ?>" value="<?php echo e($detail->masanpham); ?>" required>
                                        </div>
                                          ...
                                          <div class="row">
                                              <div class="col-xs-6">
                                                  ...
                                                  <input type="text" class="form-control" name="quantity"
                                                      placeholder="Số lượng" value="<?php echo e($detail->quantity); ?>">
                                              </div>
                                              <div class="col-xs-6">
                                                    ...
                                                    <div class="form-control">
                                                        <label>
                                                            <input type="radio" name="tinhtrang" value="1"
                                                                <?php echo e($detail->tinhtrang == '1' ? 'checked' : ''); ?>>
                                                            <small>Còn hàng</small>
                                                        </label>
                                                        <label>
                                                            <input type="radio" name="tinhtrang" value="0"
                                                                class="ml-15"
                                                                <?php echo e($detail->tinhtrang == '0' ? 'checked' : ''); ?>>
                                                    ...
                                                    <div class="form-control">
                                                        <label>
                                                            <input type="radio" name="status" value="1"
                                                                <?php echo e($detail->status == '1' ? 'checked' : ''); ?>>
                                                            <small><?php echo app('translator')->get('active'); ?></small>
                                                        </label>
                                                        <label>
                                                            <input type="radio" name="status" value="0"
                                                                class="ml-15"
                                                                <?php echo e($detail->status == '0' ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="meta_title" maxlength="255" id="meta_title"
                                                class="form-control" value="<?php echo e($detail->meta_title); ?>"
                                            ...
                                            <span id='remainingInput_meta_title'
                                                class="note pull-right"><?php echo e(mb_strlen($detail->meta_title)); ?>/255</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('seo_keyword'); ?></label>
                                            <input name="meta_keyword" maxlength="255" class="form-control"
                                                id="meta_keyword" value="<?php echo e($detail->meta_keyword); ?>"
                                            ...
                                            <span id='remainingInput_meta_keyword'
                                                class="note pull-right"><?php echo e(mb_strlen($detail->meta_keyword)); ?>/255</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('seo_description'); ?></label>
                                            <input name="meta_description" maxlength="255" id="meta_description"
                                                class="form-control" value="<?php echo e($detail->meta_description); ?>"
                                            ...
                                            <span id='remainingInput_meta_description'
                                                class="note pull-right"><?php echo e(mb_strlen($detail->meta_description)); ?>/255</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-xs-12 hidden">
                                        <div class="form-group">
                                            ...
                                            <textarea name="diemban" class="form-control" id="diemban"><?php echo e($detail->diemban); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xs-12 hidden">
                                        <div class="form-group">
                                            <label>Giấy tờ sản phẩm</label>
                                            <textarea name="giayto" class="form-control" id="giayto"><?php echo e($detail->giayto); ?></textarea>
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u745771642/domains/bibomart.thanhphung.com/public_html/resources/views/admin/pages/cms_products/edit.blade.php ENDPATH**/ ?>