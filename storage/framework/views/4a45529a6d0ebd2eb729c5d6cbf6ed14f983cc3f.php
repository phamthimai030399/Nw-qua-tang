        ...
        <section class="breadcrumb">
            <div class="container">
                <div class="breadcrumb-list">
                    ...
                    <a href="<?php echo e(route('frontend.cms.post_category')); ?>" title="Tư vấn sản phẩm"
            ...
            <div class="container">
                ...
                <div class="blog-list">
                    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="news">
                            <div class="news-img">
                                <a href="<?php echo e(route('frontend.cms.post', ['alias_detail' => $item->url_part])); ?>">
                            ...
                            <div class="news-reference">
                                ...
                                <span class="news-date">
                                    ...
                                    <?php echo e(date('Y-m-d', strtotime($item->aproved_date))); ?></span>
                            </div>
                            <a href="<?php echo e(route('frontend.cms.post', ['alias_detail' => $item->url_part])); ?>" class="news-title" title="<?php echo e($item->title); ?>"><?php echo e($item->title); ?></a>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\NEWWAY\Nw_Quatang\resources\views/frontend/pages/post/default.blade.php ENDPATH**/ ?>